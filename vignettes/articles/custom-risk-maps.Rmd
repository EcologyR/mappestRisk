...
Here we provide an example of customization with `tidyterra` for the latest risk raster obtained in the previous section for Andalucía. First, let's select the *risk* layer (if we don't specifically select it, the latest –sd– is used by default[^1]).
